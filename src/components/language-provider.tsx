...
const translations = {
  en: {
    ...
    diagnose_health: {
      ...
      description: "Use our AI tool to diagnose potential health issues in your flock.",
      form_title: "Symptom Checker",
      form_description: "Provide as much detail as possible for an accurate diagnosis.",
      symptoms_label: "Observed Symptoms",
      symptoms_placeholder: "e.g., Bloody diarrhea, ruffled feathers, paralysis, coughing, sneezing, etc.",
      age_label: "Flock Age (in weeks)",
      photo_label: "Upload Photo (Optional)",
      upload_button: "Upload Image",
      photo_description: "A photo of the sick bird or its droppings can improve diagnosis.",
      diagnose_button: "Get AI Diagnosis",
      analyzing_button: "Analyzing...",
      results_title: "AI Diagnosis Results",
      results_description: "Based on the information provided. This is not a substitute for professional veterinary advice.",
      analyzing_message: "Our AI is analyzing the symptoms...",
      possible_diseases_title: "Possible Diseases",
      likelihood: "Likelihood",
      recommended_actions_title: "Immediate Recommended Actions",
      preventative_measures_title: "Long-term Preventative Measures",
      results_placeholder: "Your diagnosis results will appear here."
    },
    daily_rates: {
      title: "Market Rates",
    },
    ...
    chat_suggestions: {
      what_is_broiler: "What is Broiler chicken?",
  ...
  hi: {
    ...
    diagnose_health: {
      title: "स्वास्थ्य निदान",
      description: "अपने झुंड में संभावित स्वास्थ्य समस्याओं का निदान करने के लिए हमारे एआई उपकरण का उपयोग करें।",
      form_title: "लक्षण चेकर",
      form_description: "सटीक निदान के लिए कृपया यथासंभव अधिक विवरण प्रदान करें।",
      symptoms_label: "देखे गए लक्षण",
      symptoms_placeholder: "जैसे, खूनी दस्त, अस्त-व्यस्त पंख, पक्षाघात, खांसी, छींकना, आदि।",
      age_label: "झुंड की आयु (सप्ताहों में)",
      photo_label: "फोटो अपलोड करें (वैकल्पिक)",
      upload_button: "छवि अपलोड करें",
      photo_description: "बीमार पक्षी या उसकी बीट की एक तस्वीर निदान में सुधार कर सकती है।",
      diagnose_button: "एआई निदान प्राप्त करें",
      analyzing_button: "विश्लेषण हो रहा है...",
      results_title: "एआई निदान परिणाम",
      results_description: "प्रदान की गई जानकारी के आधार पर। यह पेशेवर पशु चिकित्सा सलाह का विकल्प नहीं है।",
      analyzing_message: "हमारा एआई लक्षणों का विश्लेषण कर रहा है...",
      possible_diseases_title: "संभावित रोग",
      likelihood: "संभावना",
      recommended_actions_title: "तत्काल अनुशंसित कार्रवाइयां",
      preventative_measures_title: "दीर्घकालिक निवारक उपाय",
      results_placeholder: "आपके निदान के परिणाम यहां दिखाई देंगे।"
    },
    daily_rates: {
      title: "बाजार दरें",
    },
    ...
    chat_suggestions: {
      what_is_broiler: "ब्रॉयलर चिकन क्या है?",
