...
import React, { useReducer, useMemo, useRef, useState, Component } from 'react';
...
// Re-implementing as a class component for better compatibility with react-to-print
class PrintableReport extends Component<{ reportData: any, state: any, generationTime: string }> {
    render() {
