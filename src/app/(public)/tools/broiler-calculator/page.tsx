...
// Printable Report Component as a functional component for better compatibility
const PrintableReport = forwardRef<HTMLDivElement, { reportData: any, state: any, generationTime: string }>(({ reportData, state, generationTime }, ref) => {
    return (
